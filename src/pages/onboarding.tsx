            ...
            <form onSubmit={onSubmit}>
                ...
                <div className="mb-6">
                    ...
                    <textarea
                        ...
                        placeholder="Mockup, Chille, Jova, C++, Python"
                    ></textarea>
                </div>
                <div className="mb-6">
                    <label
                ...
                <div className="mb-32 flex items-center	">
                    ...
                    {processingState.loading && (
                        <div className="mx-3 flex animate-pulse text-gray-400">
                            <Hourglass className="mr-2" /> Obacht, Bitte
                            gedulden Sie
                        </div>
                    )}
                    {processingState.error && (
                        <div className="mx-3 flex animate-pulse text-red-400">
                            <CircleX className="mr-2" /> Eigschissn, Bitte
                            nochmal probieren
                        </div>
                    )}
                    {processingState.success && (
                        <div className="mx-3 flex animate-pulse text-green-400">
                            <CircleCheck className="mr-2" /> Anfrage erfolgreich
                            versendet, wir werden uns bald bei Ihnen melden.
                        </div>
                    )}
                </div>
            </form>
