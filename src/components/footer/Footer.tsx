...
const Footer = () => {
	return (
		<footer className="p-4 bg-red sm:p-6 dark:bg-gray-900 mx-auto max-w-[1200px]">
			<div className="md:flex md:justify-between">
				<div className="mb-6 md:mb-0">
					<a className="flex items-center justify-center md:justify-start ">
						<span className="self-center text-2xl font-semibold whitespace-nowrap dark:text-white">
							<div className="flex flex-col mb-10 mt-10 md:m-0 items-start w-full ">
								<FooterSlogan className="text-gray-500">effektiv.</FooterSlogan>
								<FooterSlogan className="text-gray-700">
									effizient.
								</FooterSlogan>
								<FooterSlogan className="text-gray-900">engelbyte</FooterSlogan>
								<WaterblueFooterSlogan>waterbyte.</WaterblueFooterSlogan>
							</div>
						</span>
					</a>
				</div>
				<div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3 p-2">
					<div>
			...
			<hr className="my-6 border-gray-200 sm:mx-auto dark:border-gray-700 lg:my-8 m-8" />
			<div className="sm:flex sm:items-center sm:justify-between">
				<span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">
					...
					<span className="italic">
						Diese Seite wurde mit der Waterbyte Projektstrategie umgesetzt.
					</span>
				</span>
          ...
          >
            ...
            <span className="sr-only">Facebook page</span>
					...
					<a
						href="https://www.youtube.com/@engelbytewaterbyte"
						className="text-gray-500 hover:text-gray-900 dark:hover:text-white"
					>
						<svg
							xmlns="http://www.w3.org/2000/svg"
							className="w-5 h-5 icon icon-tabler icon-tabler-brand-youtube"
							width="44"
							height="44"
							viewBox="0 0 24 24"
							strokeWidth="1.5"
